  ...
  const faqItems = [
    {
      ...
      answer:
        "AlphaByte is a 36-hour hackathon where participants work on innovative solutions to real-world problems. It's organized by GDGC PCCOE and features multiple tracks including Web Development, AI/ML, and Blockchain.",
    },
    {
      question: "Who can participate?",
      answer:
        "Any college student can participate. Teams should have 3-4 members, and cross-college teams are allowed.",
    },
    {
        ...
        <div className="space-y-6">
          {faqItems.map((item, index) => (
            ...
            >
              ...
              <div
                className={`px-6 py-4 border-t border-neutral-700 ${
